...
export const createRecommendationService = async (formData) => {
  ...
  const res = await fetch(`${baseURL}/usuarioId/recomendacion`, {
    method: "post",
    headers: {
      Authorization: token,
    },
...
export const handleUpvoteService = async (recommendationId, method) => {
  ...
  const res = await fetch(
    `${baseURL}/recomendaciones/${recommendationId}/likes`,
    {
      // Fixed the URL path
...
export const handleDownvoteService = async (recommendationId) => {
  ...
  const res = await fetch(`${baseURL}/recomendaciones/${recommendationId}`, {
    // Fixed the URL path and 'delete' method
