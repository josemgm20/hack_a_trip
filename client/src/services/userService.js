...
export const signInService = async (username, password) => {
    // Modificar datos conforme a lo realizado y requerido en el server y POSTMAN
    const res = await fetch(`${baseURL}/users/login`, {
        // Modificar el fetch conforme esté realizado en el POSTMAN personal, según  tu dirección.
        method: 'post',
        headers: {
            'Content-Type': 'application/json',
        },
